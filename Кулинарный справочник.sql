...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Мар 12 2024 г., 12:01
...
CREATE TABLE `dishes` (
  ...
  `Cooking_Time` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
  `id_categories` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `dishes` (`id_dishes`, `name`, `Cooking_Method`, `Cooking_Time`, `id_categories`) VALUES
(1, 'Шашлык - Мясной обитель - свиной', 'Копчение на углях', '120 min', 1),
(2, 'Шашлык - Благосклонность природы - грибной', 'Копчение на углях', '120 min', 1),
(3, 'Шашлык - Рай из глубин - рыбный', 'Копчение на углях', '120 min', 1),
(4, 'Суп - Котёл тысячи сердец - Борщ', 'Варка', '90 min', 2),
(5, 'Суп - Всё из ничего - Солянка', 'Варка', '90 min', 2),
(6, 'Суп - Сногсшибательный - Гороховый', 'Варка', '90 min', 2),
(7, 'Салат - Новогодний – Цезарь', 'Смешивание ингредиентов', '25 min', 3),
(8, 'Салат - Деревенский – Ёжик', 'Смешивание ингредиентов', '15 min', 3),
(9, 'Салат - Поход дьявола - Винегрет', 'Смешение ингредиентов', '40 min', 3);
